            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    </div>
                    {
                        ...
                        //     <input type="button" value="+" className='btn btn-primary btn-sm'
                        //         // onClick={addItem}
                        //         onClick={() => { addItem(); handleFocusInput(); }}
                        //     />
                        // </div>
                    }
                    {/* {
                        <div className="col-md-4 mt-4  mb-2 btn-md " >
                            <input type="submit" value="Submit Menu" className='btn btn-primary'
                                onClick={addItem}
                            />
                        </div>
                    } */}
                    {
                        togglesubmit ? <div className="col-md-4 mt-4  mb-2 btn-md">
                            <input type="submit" value="Submit" className='btn btn-primary'
                                onClick={addItem}
                            />            </div> : <div className="col-md-2 mt-4  mb-2 btn-md">
                        ...
                        items.map((elem, ind) => {
                            return (
                                <>
                                    ...
                                    <div className="col-md-2 mt-3" key={ind}>
                                        <button
                ...
                <div className=" btn effect04 mt-5 " data-sm-link-text="RemoveAll" >
                    {items.length >= 1 &&
                        <button className='btn btn-danger mt-1'
                            ...
                            onClick={() => {
                                if (
                                    window.confirm("Are you sure to remove all item ??")
                                ) {
                                    removeall();
                                }
                            }}
